...
-- Dumping database structure for phpbook-1
CREATE DATABASE IF NOT EXISTS `phpbook-1` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
USE `phpbook-1`;

-- Dumping structure for table phpbook-1.article
...
-- Dumping data for table phpbook-1.article: ~26 rows (approximately)
...
INSERT INTO `article` (`id`, `title`, `summary`, `content`, `created`, `category_id`, `member_id`, `image_id`, `published`) VALUES
	...
	(25, 'Nowday', 'Oxford Online English', 'Oxford Online English is a platform that offers online English language learning resources and courses', '2023-05-22 06:02:00', 3, 2, 20, 0),
	(26, 'Thursday', 'Thursday is the fourth day of the week between Wednesday and Friday, and is named after Thor', 'Thursday is the fourth day of the week between Wednesday and Friday, and is named after Thor, the hammer-wielding Norse god of thunder.', '2023-05-25 14:48:00', 2, 3, 7, 0);
/*!40000 ALTER TABLE `article` ENABLE KEYS */;

-- Dumping structure for table phpbook-1.category
...
-- Dumping data for table phpbook-1.category: ~4 rows (approximately)
...
-- Dumping structure for table phpbook-1.image
...
-- Dumping data for table phpbook-1.image: ~23 rows (approximately)
...
-- Dumping structure for table phpbook-1.member
...
-- Dumping data for table phpbook-1.member: ~3 rows (approximately)
